...
Original file is located at
    https://colab.research.google.com/drive/10ifkW0XlRdd2c3Kvg0ux26wOPu1W4ZNJ
"""
...
raw_df = pd.read_csv('./lyrics_by_year_1964_2023.csv', encoding='utf-8') # 멜론 순위권 노래 가사 데이터 불러오기
...
def update_graph(year):
    ...
    print(f"Korean words graph saved as: {kr_path}")
    ...
    if len(top_words_per_year_en[year]) > 0:  # 영어 단어가 존재하는지 확인
        ...
        print(f"English words graph saved as: {en_path}")
    else:
